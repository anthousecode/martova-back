...
INSERT INTO "admin_permissions" VALUES (1,'All permission','*','','*',NULL,NULL),(2,'Dashboard','dashboard','GET','/',NULL,NULL),(3,'Login','auth.login','','/auth/loginrn/auth/logout',NULL,NULL),(4,'User setting','auth.setting','GET,PUT','/auth/setting',NULL,NULL),(5,'Auth management','auth.management','','/auth/rolesrn/auth/permissionsrn/auth/menurn/auth/logs',NULL,NULL);
...
CREATE TABLE "menus" (
  ...
  "ua_name" varchar(255) NOT NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT "menus_order_unique" UNIQUE  ("order")
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE "pages" (
  ...
  "ua_title" varchar(255) NOT NULL,
  "ua_content" longtext NOT NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT "pages_ru_title_unique" UNIQUE  ("ru_title"),
  CONSTRAINT "pages_ua_title_unique" UNIQUE  ("ua_title")
);
/*!40101 SET character_set_client = @saved_cs_client */;
